"""
Django settings for contactsite project.
...
ALLOWED_HOSTS = ['morning-fjord-25020.herokuapp.com', '127.0.0.1']
...
WSGI_APPLICATION = 'contactsite.wsgi.application'
